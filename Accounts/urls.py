...
from .views import LoginUser, ProfileUser, RegisterUser,LogoutUser,ChangePassword,UpdateUserView
...
urlpatterns = [
    ...
    path('update/user',UpdateUserView.as_view(),name='user_change_info'),
